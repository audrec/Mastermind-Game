...
The computer will randomly select a pattern of [Length] different numbers from [Minimum Number] to [Maximum Number].
...
(Example: For easy level, the computer will randomly select a pattern of [4] different numbers from a total of 8 different numbers from [0] to [7].)
!["Instruction for easy mode when easy level was selected."](https://github.com/audrec/Mastermind-Game/blob/126de3f70ad553ee1d89da6e896112722f4f69b4/ProgramScreenshots/easyMode.png)

Invalid input for level choosing will show error message, and ask the user to choose the level again.
!["Error message when invalid level input entered"](https://github.com/audrec/Mastermind-Game/blob/bb823259da58c30eeab1a901f11f4ec55baf96fc/ProgramScreenshots/ErrorLevelInput.png)
...
!["Sample input on the console"](https://github.com/audrec/Mastermind-Game/blob/bb823259da58c30eeab1a901f11f4ec55baf96fc/ProgramScreenshots/SampleInput.png)

If the target numbers was successfully guessed by the user, the program will exit with the message: "You won!".
!["When the user won the game"](https://github.com/audrec/Mastermind-Game/blob/bb823259da58c30eeab1a901f11f4ec55baf96fc/ProgramScreenshots/Won.png)
...
!["When the user lost the game"](https://github.com/audrec/Mastermind-Game/blob/bb823259da58c30eeab1a901f11f4ec55baf96fc/ProgramScreenshots/Lost.png)
...
!["Error handling for invalid user input"](https://github.com/audrec/Mastermind-Game/blob/bb823259da58c30eeab1a901f11f4ec55baf96fc/ProgramScreenshots/errorNumbersInput.png)
...
!["When secret code is entered, user wins the game directly."](https://github.com/audrec/Mastermind-Game/blob/bb823259da58c30eeab1a901f11f4ec55baf96fc/ProgramScreenshots/godMode.png)
